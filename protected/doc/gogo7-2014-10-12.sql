...
CREATE TABLE `app_image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='app图片管理表';
...
CREATE TABLE `bijia` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='比价表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='优惠券表';
...
CREATE TABLE `weblink` (
  ...
  `url` varchar(128) NOT NULL DEFAULT '' COMMENT '网址',
  `type_id` int(11) NOT NULL DEFAULT '0' COMMENT '分类（10商家链接，20首页banner,30首页通栏banner）',
  `sorting` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `city_id` int(11) NOT NULL DEFAULT '0' COMMENT '所属城市',
  `image` varchar(128) NOT NULL DEFAULT '' COMMENT '图片',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='网站链接表';
