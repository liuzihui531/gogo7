...
CREATE TABLE `outlets` (
  ...
  `traffic_mode` varchar(512) NOT NULL DEFAULT '' COMMENT '交通方式',
  `scene` varchar(512) NOT NULL DEFAULT '' COMMENT '临近景点',
  `brand` text COMMENT '主要品牌',
  `shopping_index` tinyint(1) NOT NULL DEFAULT '0' COMMENT '必逛指数',
...
-- Records of outlets
-- ----------------------------
INSERT INTO `outlets` VALUES ('1', 'fsdaf', '1', '', 'http://www.fasdfasf.com', 'saf', 'asf', 'asdfas', 'asdfasf', '', null, '1', '11', 'asdf', '1', 'asf', 'asf', '1412474558');
INSERT INTO `outlets` VALUES ('2', 'dfdsf', '1', '', '', 'sadf', 'dfd', '', '', '', null, '1', '0', '', '0', '', '', '1412651603');
