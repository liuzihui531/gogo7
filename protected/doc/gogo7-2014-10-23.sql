...
CREATE TABLE `app_image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='app图片管理表';
...
CREATE TABLE `brand` (
  ...
  `if_use` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否使用',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
-- Records of brand
-- ----------------------------
INSERT INTO `brand` VALUES ('18', '纽约品牌1', '', '5,1', 'dd', '', '0', 'N', '1', '1412150892');
INSERT INTO `brand` VALUES ('19', '伦敦品牌1', 'adsfa', '4', 'dd', '/upload/1410/0108/09/542bb6aef3d92.jpg', '0', 'L', '1', '1412150958');
INSERT INTO `brand` VALUES ('20', '伦敦品牌2', '1', '5', '', '', '0', 'L', '1', '1412151183');
INSERT INTO `brand` VALUES ('23', '纽约品牌2', '', '5', '', '', '1', 'N', '1', '1413725609');
...
INSERT INTO `brandcate` VALUES ('4', '电子', '6', '', '0', '', '1412145016');
...
INSERT INTO `brandcate_relation` VALUES ('23', '5');
...
INSERT INTO `brandcity_relation` VALUES ('19', '3');
INSERT INTO `brandcity_relation` VALUES ('20', '3');
INSERT INTO `brandcity_relation` VALUES ('23', '1');
...
CREATE TABLE `business_circle` (
  ...
  KEY `city_id` (`city_id`),
  KEY `bc_name` (`bc_name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='商圈表';
...
INSERT INTO `business_circle` VALUES ('3', 'sdfsd', '', '', '', '', '', '', '5', '3', '0', '', '', null, '1', '1', '1413820763');
...
-- Records of city
-- ----------------------------
INSERT INTO `city` VALUES ('1', '时尚之都纽约', 'new york', '1', '3', 'affasfasdfasd', 'fsadfasdfdd', '/upload/1409/2812/33/54280020a9979.jpg', '', '1', '1411907616');
INSERT INTO `city` VALUES ('2', '加州', 'asf', '1', '0', 'sfas', 'asfsd', '', '', '0', '1413810664');
INSERT INTO `city` VALUES ('3', '伦敦', 'afdf', '2', '0', '', 'asdf', '', '', '1', '1413810700');
INSERT INTO `city` VALUES ('4', '柏林', 'df', '2', '0', 'sfdf', '', '', '', '0', '1413810726');
...
CREATE TABLE `comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` enum('share','outlets','seller','coupon','bc') NOT NULL COMMENT '类型，share购物心得，outlets,bc商圈,seller商家,coupon优惠券',
...
-- Records of coupon
-- ----------------------------
INSERT INTO `coupon` VALUES ('3', 'fasdfsd', '11', '3', '8', '3', '0', '/upload/1410/2114/16/54466aa0a5024.jpg', '', '1411948800', '1414627200', '0', '0', '1', '1413900960');
INSERT INTO `coupon` VALUES ('4', 'fasdfsd', '10', '2', '7', '1', '0', '/upload/1410/2114/16/54466aa0a5024.jpg', '', '1411948800', '1414627200', '0', '0', '1', '1413900960');
INSERT INTO `coupon` VALUES ('5', 'fasdfsd', '9', '2', '7', '1', '0', '/upload/1410/2114/16/54466aa0a5024.jpg', '', '1411948800', '1414627200', '0', '0', '1', '1413900960');
...
INSERT INTO `couponbrand_relation` VALUES ('3', '23');
...
INSERT INTO `couponbrand_relation` VALUES ('4', '23');
INSERT INTO `couponbrand_relation` VALUES ('5', '18');
INSERT INTO `couponbrand_relation` VALUES ('5', '19');
INSERT INTO `couponbrand_relation` VALUES ('5', '20');
INSERT INTO `couponbrand_relation` VALUES ('5', '23');
...
-- Records of outlets
-- ----------------------------
INSERT INTO `outlets` VALUES ('7', '纽约outlets', '1', '', '', '', '', '', '', '5', '0', '', '1', '', '', '1413820582');
INSERT INTO `outlets` VALUES ('8', '伦敦outlets', '3', '', '', '', '', '', '', '5', '0', '', '1', '', '', '1413820599');
...
-- ----------------------------
INSERT INTO `outletsbrand_relation` VALUES ('7', '18');
INSERT INTO `outletsbrand_relation` VALUES ('7', '23');
INSERT INTO `outletsbrand_relation` VALUES ('8', '19');
INSERT INTO `outletsbrand_relation` VALUES ('8', '20');
...
-- ----------------------------
INSERT INTO `outletsscene_relation` VALUES ('7', '2');
INSERT INTO `outletsscene_relation` VALUES ('7', '4');
INSERT INTO `outletsscene_relation` VALUES ('8', '3');
INSERT INTO `outletsscene_relation` VALUES ('8', '5');
...
CREATE TABLE `scene` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_id` (`city_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='景点表';

-- ----------------------------
-- Records of scene
-- ----------------------------
INSERT INTO `scene` VALUES ('3', '伦敦景点1', 'aaa', '3', '', '0', '', '', '1', '1413810783');
INSERT INTO `scene` VALUES ('2', '纽约景点2', 'tttttt', '1', '', '0', 'fasdfasdf', '', '1', '1411914284');
INSERT INTO `scene` VALUES ('4', '纽约景点1', 'asdf', '1', '', '0', 'asdf', '', '1', '1413811226');
INSERT INTO `scene` VALUES ('5', '伦敦景点2', 'dfd', '3', '', '0', '', '', '1', '1413815361');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='商家表';

-- ----------------------------
-- Records of seller
-- ----------------------------
INSERT INTO `seller` VALUES ('9', '纽约商家1', '1', '2', '7', '5', '', '', '', '', '', '', '', '', '', '', '', '', 'gogousa', 'gogousa', '', '', '1', '1', '1413899711');
INSERT INTO `seller` VALUES ('10', '纽约商家2', '1', '2', '7', '5', '', '', '', '', '', '', '', '', '', '', '', '', 'gogousa', 'gogousa', '', '', '1', '1', '1413899776');
INSERT INTO `seller` VALUES ('11', '伦敦商家1', '3', '3', '8', '5', '', '', '', '', '', '', '', '', '', '', '', '', 'gogousa', 'gogousa', '', '', '1', '1', '1413899800');
...
-- ----------------------------
INSERT INTO `sellerbrand_relation` VALUES ('9', '18');
INSERT INTO `sellerbrand_relation` VALUES ('9', '23');
INSERT INTO `sellerbrand_relation` VALUES ('10', '18');
INSERT INTO `sellerbrand_relation` VALUES ('10', '23');
INSERT INTO `sellerbrand_relation` VALUES ('11', '19');
INSERT INTO `sellerbrand_relation` VALUES ('11', '20');
...
-- ----------------------------
INSERT INTO `sellercate_relation` VALUES ('9', '1');
INSERT INTO `sellercate_relation` VALUES ('9', '2');
INSERT INTO `sellercate_relation` VALUES ('10', '1');
INSERT INTO `sellercate_relation` VALUES ('10', '2');
INSERT INTO `sellercate_relation` VALUES ('11', '1');
INSERT INTO `sellercate_relation` VALUES ('11', '2');
...
-- ----------------------------
INSERT INTO `sellerscene_relation` VALUES ('9', '2');
INSERT INTO `sellerscene_relation` VALUES ('9', '4');
INSERT INTO `sellerscene_relation` VALUES ('10', '2');
INSERT INTO `sellerscene_relation` VALUES ('10', '4');
INSERT INTO `sellerscene_relation` VALUES ('11', '3');
INSERT INTO `sellerscene_relation` VALUES ('11', '5');
...
CREATE TABLE `share` (
  ...
  KEY `area_id` (`area_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='购物心得表';

-- ----------------------------
-- Records of share
-- ----------------------------
INSERT INTO `share` VALUES ('3', 'sdfds', '6', '0', '', '<p>sdfdsdf</p>', '', '', '', '0', '0', '0', '0', '1413293465');
INSERT INTO `share` VALUES ('4', 'asffdasf', '6', '0', '', '<p>asdf</p>', '', '', 'asdf', '0', '0', '0', '0', '1413904415');
INSERT INTO `share` VALUES ('5', 'fasdfd', '5', '2', 'sdfds', '<p>asdfasd<img src=\"/upload/1410/2213/51/5447b65258c29.jpg\" /></p>', '', '', '', '0', '0', '0', '0', '1413985877');
...
INSERT INTO `upload` VALUES ('57', '0', '0', '0', '0', '54465e6ba3fbc.jpg', '/upload/1410/2113/23/54465e6ba3fbc.jpg', '430160', 'jpg', '80x80,60x60', '', '1', '1413897835');
INSERT INTO `upload` VALUES ('58', '0', '0', '0', '0', '54465e6be789a.jpg', '/upload/1410/2113/23/54465e6be789a.jpg', '366221', 'jpg', '80x80,60x60', '', '1', '1413897836');
INSERT INTO `upload` VALUES ('59', '0', '0', '0', '0', '54465e6c30724.jpg', '/upload/1410/2113/23/54465e6c30724.jpg', '255705', 'jpg', '80x80,60x60', '', '1', '1413897836');
INSERT INTO `upload` VALUES ('60', '0', '0', '0', '0', '54465e6c5c37e.jpg', '/upload/1410/2113/23/54465e6c5c37e.jpg', '1455575', 'jpg', '80x80,60x60', '', '1', '1413897837');
INSERT INTO `upload` VALUES ('61', '0', '0', '0', '0', '54465e6d2c992.jpg', '/upload/1410/2113/23/54465e6d2c992.jpg', '1433044', 'jpg', '80x80,60x60', '', '1', '1413897838');
INSERT INTO `upload` VALUES ('62', '0', '0', '0', '0', '54465f9ab49d3.jpg', '/upload/1410/2113/28/54465f9ab49d3.jpg', '2029142', 'jpg', '80x80,60x60', '', '1', '1413898139');
INSERT INTO `upload` VALUES ('63', '0', '0', '0', '0', '54465fac7e9e1.jpg', '/upload/1410/2113/29/54465fac7e9e1.jpg', '566630', 'jpg', '80x80,60x60', '', '1', '1413898156');
INSERT INTO `upload` VALUES ('64', '0', '0', '0', '0', '54465facc9f0a.jpg', '/upload/1410/2113/29/54465facc9f0a.jpg', '1665624', 'jpg', '80x80,60x60', '', '1', '1413898157');
INSERT INTO `upload` VALUES ('65', '0', '0', '0', '0', '54465fe5b2164.jpg', '/upload/1410/2113/30/54465fe5b2164.jpg', '366221', 'jpg', '80x80,60x60', '', '1', '1413898213');
INSERT INTO `upload` VALUES ('66', '0', '0', '0', '0', '5446600b69e73.jpg', '/upload/1410/2113/30/5446600b69e73.jpg', '566630', 'jpg', '80x80,60x60', '', '1', '1413898251');
INSERT INTO `upload` VALUES ('67', '0', '0', '0', '0', '54466aa0a5024.jpg', '/upload/1410/2114/16/54466aa0a5024.jpg', '430160', 'jpg', '80x80,60x60', '', '1', '1413900960');
INSERT INTO `upload` VALUES ('68', '0', '0', '0', '0', '54466eb3e7a76.jpg', '/upload/1410/2114/33/54466eb3e7a76.jpg', '430160', 'jpg', '80x80,60x60', '', '1', '1413902004');
INSERT INTO `upload` VALUES ('69', '0', '0', '0', '0', '5447b65258c29.jpg', '/upload/1410/2213/51/5447b65258c29.jpg', '119782', 'jpg', '', '', '1', '1413985874');
...
CREATE TABLE `vipcoupon` (
  ...
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='VIP优惠券';

-- ----------------------------
-- Records of vipcoupon
-- ----------------------------
INSERT INTO `vipcoupon` VALUES ('5', 'as', 'dsfad', '/upload/1410/2114/33/54466eb3e7a76.jpg', '0', '0', '1413902003');
