    ...
    <tr>
        <td colspan='8'>
            <form action="<?php echo $this->createUrl('index') ?>" method='get'>
                <a href="<?php echo $this->createUrl('create') ?>" class='bta'>添加购物心得分类</a>
                <span id='delall' class='bta' onclick='delall()'>删除</span>
                <input type='text' name='name' placeholder="分类名称" value="<?php echo Yii::app()->request->getParam('name') ?>" style='height:27px;margin:0 10px'   />
