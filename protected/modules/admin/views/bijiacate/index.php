    ...
    <tr>
        <td colspan='8'>
            <form action="<?php echo $this->createUrl('index') ?>" method='get'>
                <a href="<?php echo $this->createUrl('create') ?>" class='bta'>添加比价分类</a>
        ...
        <tr><td>ID</td><td><input type='checkbox' id='checkAll' myid='0'  />选择</td><td>名称</td><td>品牌名称</td><td>创建日期</td><td>操作</td></tr>
