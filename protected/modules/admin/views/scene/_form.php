...
<table class="table">
    <tr>
        <td align="right" width="20%">
            <?php echo $form->labelEx($model, 'scene_name') ?>
        </td>
        <td>
            <?php echo $form->textField($model, 'scene_name') ?>
            <div class='form-error'><?php echo $form->error($model, 'scene_name'); ?></div>
        </td>
        </td>
    </tr>
    <tr>
        <td align="right" width="20%">
            <?php echo $form->label($model, 'scene_en_name') ?>
        </td>
        <td>
            <?php echo $form->textField($model, 'scene_en_name') ?>
            <div class='form-error'><?php echo $form->error($model, 'scene_en_name'); ?></div>
        </td>
    </tr>
    <tr>
        <td align="right" width="20%">
        ...
        <td>
            <?php echo $form->dropDownList($model, 'city_id',  City::model()->getCityKv()) ?>
