...
$form = $this->beginWidget('CActiveForm', array(
    'id' => 'id-form',
    'action' => $this->createUrl('quicksave'),
...
?>
<?php if ($isEdit): ?>
    <input type="hidden" name="oldId" value="<?php echo $model->id; ?>" />
<?php endif; ?>
<table class="table">
    <tr>
        ...
        <td>
            ...
            <?php if ($isEdit): ?>
                <span style="position:relative;width:100px;height:100px">
                    ...
                    <img src="<?php echo $model->big_image ?>" style="width:100px;height:100px" />
                </span>
        ...
        <td>
            ...
            <?php if ($isEdit): ?>
                <span style="position:relative;width:100px;height:100px">
                    ...
                    <img src="<?php echo $model->image_one ?>" style="width:100px;height:100px" />
                </span>
        ...
        <td>
            ...
            <?php if ($isEdit): ?>
                <span style="position:relative;width:100px;height:100px">
                    ...
                    <img src="<?php echo $model->image_two ?>" style="width:100px;height:100px" />
                </span>
        ...
        <td>
            ...
            <?php if ($isEdit): ?>
                <span style="position:relative;width:100px;height:100px">
                    ...
                    <img src="<?php echo $model->image_three ?>" style="width:100px;height:100px" />
                </span>
        ...
        <td>
            ...
            <?php if ($isEdit): ?>
                <span style="position:relative;width:100px;height:100px">
                    ...
                    <img src="<?php echo $model->image_four ?>" style="width:100px;height:100px" />
                </span>
