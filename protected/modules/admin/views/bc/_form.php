...
<table class="table">
    <tr>
        <td align='right' width='26%'><?php echo $form->labelEx($model, 'bc_name') ?></td>
        <td width='75%'>
            <?php echo $form->textField($model, 'bc_name') ?>
            <div class='form-error'><?php echo $form->error($model, 'bc_name'); ?></div>
        </td>
    </tr>
    <tr>
